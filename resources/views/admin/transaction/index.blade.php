                                            ...
                                            <td>
                                                @if ($transaction->payments)
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li>Tổng tiền: {{ number_format($transaction->payments->p_money) }}
                                                            VNĐ</li>
                                                        <li>Thời gian:
                                                            {{ date('H:i d-m-Y', strtotime($transaction->payments->p_time)) }}
                                                        </li>
                                                        <li></li>
                                                    </ul>
                                                @else
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            <a href="{{ route('admin.transaction.delete', $transaction->id) }}"
                                                                class="js-delete-confirm"><i class="fa fa-trash"></i>
                                                                Delete</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li>
                                                            <a
                                                                href="{{ route('admin.action.transaction', ['process', $transaction->id]) }}"><i
                                                                    class="fa fa-ban"></i> Đang bàn giao</a>
                                                        </li>
                                                        <li>
                                                            <a
                                                                href="{{ route('admin.action.transaction', ['success', $transaction->id]) }}"><i
                                                                    class="fa fa-ban"></i> Đã bàn giao</a>
                                                        </li>
                                                        <li>
                                                            <a
