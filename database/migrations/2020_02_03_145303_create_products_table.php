...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->string('pro_name_sale')->nullable();
            $table->string('pro_name_chay')->nullable();
            ...
            $table->string('pro_avatar1')->nullable();
            $table->string('pro_avatar2')->nullable();
            $table->string('pro_avatar3')->nullable();
            $table->string('pro_avatar4')->nullable();
            $table->string('pro_avatar5')->nullable();
            $table->string('pro_avatar6')->nullable();
