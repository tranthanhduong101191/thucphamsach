...
class CategoryController extends FrontendController
{
    public function index(Request $request, $slug)
    {
        ...
        if ($id) {
            ...
            $products = $products->select('id','pro_name','pro_name_sale','pro_name_chay','pro_slug','pro_sale','pro_avatar','pro_avatar1','pro_avatar2','pro_avatar3','pro_avatar4','pro_avatar5','pro_price','pro_review_total','pro_review_star')
                ->paginate(12);
