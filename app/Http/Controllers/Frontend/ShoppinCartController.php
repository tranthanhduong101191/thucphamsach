...
class ShoppinCartController extends Controller
{
   ...
   public function dadd(Request $request, $id)
   {
      $product = Product::find($id);
   ...
   public function createPayment(Request $request)
   {
      ...
      $inputData = array(
         ...
         "vnp_OrderType" => 'test thanh toán online',
      ...
      PaymentRequest::insert($inputData);
      // ============
      ksort($inputData);
      $query = "";
      $i = 0;
